<%@ Page Language="c#" Inherits="CL.Utility.Web.BasicData.Register" CodeFile="项目详细信息.aspx.cs" EnableEventValidation="false" %>
                ...
                <tfoot>
                    ...
                    <tr>
                       <td class="auto-style8"> 
                        ...
                        <td class="auto-style9">
                    <asp:Button ID="btback" runat="server"  Text="返回" CssClass=" btn btn-danger" OnClick="btback_Click" />
                            <br />
                            选择模板：
