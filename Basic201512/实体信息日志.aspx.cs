...
public partial class Basic201512_实体信息日志 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ViewState["init"] = "select * from e_log where Message like'%捐赠人%'or Message like'%受助人%' or Message like '%经办单位%' or Message like '%信息%'  or Message like '%用户%' order by ID DESC";
