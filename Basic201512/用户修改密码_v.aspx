...
<body id="thebody" align="left">
    ...
    <div class="body">
        ...
        <div id="div_dynamic">
            <table width="400px" align="center"  width="550px">
                ...
                <tr>             
                    ...
                    <td class="auto-style12">
                        <asp:TextBox runat="server" ID="txtID" class="form-control" Width="250px" ReadOnly="true" ></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style11">
                        <asp:TextBox runat="server" ID="txtName" class="form-control" Width="250px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style11">
                        <asp:TextBox runat="server" MaxLength="20" ID="txtPWDOld" TextMode="Password" class="form-control" Width="250px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style11">
                        <asp:TextBox runat="server" MaxLength="20"  ID="txtPWD" TextMode="Password" class="form-control" Width="250px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server"  MaxLength="20" ID="txtPWD2" TextMode="Password" class="form-control" Width="250px"></asp:TextBox>
                    </td>
                </tr>    
                <tr>
                    <td></td>
