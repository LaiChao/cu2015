    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        //      dtUsers = entityUsers.ExecuteDataTable2(CommandType.Text, "SelectById", hd);
            ...
            try
            {
                ...
                string sqldate1 = string.Format("insert into e_user(user,password,benfactorFrom,name,TEL) values('{0}','{1}','{2}','{3}','{4}')", strID, strPwd, strFrom, strName, strTEL);
           //     bool result = Convert.ToBoolean(entityUsers.Insert(dr));
                ...
                {
                    labError.ForeColor = System.Drawing.Color.Red;
                    labError.Text = "注册成功！等待管理员为您开通权限！";
